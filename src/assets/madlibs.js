    ...
    "templates": [
        {
            ...
            "blanks": ["a foreign country", "an adverb", "an adjective", "an animal", 
                        "a verb ending in 'ing'", "a verb", "a verb ending in 'ing'",
                        "an adverb", "an adjective", "a place", "a type of liquid", "a part of the body", "a verb"],
        ...
        },
        {
            ...
            "blanks": ["an adjective", "a verb", "a verb", "a verb", "a plural noun", "a verb", "a verb", "a past tense verb", "a plural noun", "an adjective", "a verb",
                        "a plural noun", "a noun", "a verb", "a past tense verb", "a noun", "a noun", "a noun", "a past tense verb", "an adjective", "a past tense verb",
                        "a past tense verb", "a noun", "a past tense verb"],
        ...
        },
        {
            ...
            "blanks": ["a noun", "an adjective", "a verb", "an adverb", "a noun", "an adjective", "a plural noun", "a plural noun", "a plural noun", "a part of the body", "a noun",
                        "a noun", "a noun", "a noun", "a part of the body"],
        ...
        },
        {
            ...
            "blanks": ["a plural noun", "an adverb", "a verb", "an article of clothing", "a body part", "an adjective", "a noun", "a plural noun", "another body part", "a plural noun",
                        "another body part", "a noun", "a noun", "a verb ending in 'ing'", "an adjective", "an adjective", "a verb"],
        ...
        {
            "title": "The Fun Park",
            "blanks": ["an adjective", "a plural noun", "a noun", "an adverb", "a number", "a past tense verb", "an adjective ending in -est", "a past tense verb", "an adverb", "an adjective"],
        ...
        },
        {
            ...
            "blanks": ["an adjective", "an adjective", "a number", "an adjective", "an animal", "a noun", "an animal", "a name", "a verb", "an adjective", "an adjective"],
            "value": ["Every summer, I get totally amped and ", " to go camping in the deep, ", " forests. It's good to get away from it all - but not too far, like getting lost! Last year, my friend and I went hiking and got lost for ", 
                        ...
                        ", we began to panic. It was getting darker and our flashlights were running on ", ". I'm sure glad my pet ", ", ", ", was with us. It is one gifted creature, because it was able to guide us back by ",
                        " the ", " s'mores by the campfire. This year, before setting off on a(n) ", " journey, I'll be sure to have working flashlights - and of course, my gifted pet!"]
        },
        {
            "title": "Weird News",
        ...
        {      
            ...
            "blanks": ["an adjective", "an adjective", "a body part", "a verb ending in -ing", "a verb", "a verb", "a verb", "a noun", "a verb", "a verb", "a body part", "a verb", "a verb", "a verb", "a noun", "a body part", "an adjective"],
        ...
        {
                "title": "Our Cafeteria",
                "blanks": ["an adjective", "a verb", "an adjective", "a noun", "a verb", "an adjective", "a noun", "an adjective", "an adjective", "a noun", "a noun"],
        ...
        },
        {
                ...
                "blanks": ["an adjective", "an adjective", "a noun", "an adjective", "an adjective", "a verb", "a verb", "a verb", "an adjective", "a verb"],
                "value": ["Yesterday, my friend and I went to the park. On our way to the ", " park, we saw big ", " balloons tied to a ", ". Once we got to the ", " park, the sky turned ",
                        ". It started to ", " and ", ". My friend and I ", " all the way home. Tomorrow we will try to go to the ", " park again and hopefully it doesnt ", "!"]
        },
        {
                "title": "A Scary Halloween Story",
                "blanks": ["an adjective", "a name", "an adjective", "a noun", "a verb", "an animal", "an adjective", "a name", "an adjective", "a noun", "a noun"],
        ...
        {
                "title": "Zombie Picnic",
                "blanks": ["a verb", "a verb", "a body part", "a body part", "a body part", "a noun", "an adjective", "a type of liquid", "a body part", "a verb", "an adjective", "a body part", "a body part"],
        ...
        {
                "title": "North Pole",
                "blanks": ["a plural noun", "an adjective", "a plural noun", "a verb", "a verb", "a number", "a noun", "an adjective", "a plural noun", "a plural noun", "an animal", "a verb", "a verb", "a plural noun"],
        ...
        {
                "title": "Snowstorm!",
                "blanks": ["a noun", "an adjective", "a noun", "a noun", "an adjective", "an adjective", "an adjective", "a noun", "a noun", "an adjective"],
                "value": ["Weather plays an important part in our ", "s everyday. What is weather, you ask? According to ", " scientists, who are known as meteorologists, weather is what the ",
        ...
        },
        {
                ...
                "blanks": ["an adjective", "a noun", "a plural noun", "an adjective", "a plural noun", "a plural noun", "an animal (plural)", "a plural noun", "a plural noun", "a number", "a number", "a plural noun", "an adjective", "a plural noun"],
            ...
            {
                "title": "Star Wars",
                "blanks": ["an adjective", "a noun", "an adjective", "a noun (place)", "an adjective", "an adjective", "an adjective", "an adjective", "a plural noun", "an adjective", "a plural noun", "a plural noun", "an adjective", 
